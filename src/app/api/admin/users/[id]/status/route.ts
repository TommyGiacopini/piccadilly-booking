...
import { changeManagedUserStatus } from "@/modules/identity/application/identity-service";
...
export async function PATCH(
  ...
  try {
    ...
    console.error("User status change failed.");
    return noStoreJson({ error: "Non è stato possibile cambiare lo stato." }, 500);
  }
}
